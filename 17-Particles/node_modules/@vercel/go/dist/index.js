 ...
 */
async function getRenamedEntrypoint(entrypoint, files) {
...
`);
    ...
    const downloadedFiles = await build_utils_1.download(files, downloadPath, meta);
    ...
    for (const file of Object.keys(downloadedFiles)) {
        ...
        if (file === 'go.mod') {
            ...
            if (!isGoModInRootDir && config.zeroConfig && file === 'api/go.mod') {
                ...
                await fs_extra_1.move(fsPath, newFsPath);
